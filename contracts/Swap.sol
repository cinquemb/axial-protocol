...
contract Swap is OwnerPausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    /**
     * @dev Initializes this Swap contract with the given parameters.
    ...
    /**
     * @dev Modifier to check deadline against current timestamp
    ...
    /**
     * @dev Return A in its raw precision form
     * @dev See the StableSwap paper for details
    ...
    /**
     * @dev Return address of the pooled token at given index. Reverts if tokenIndex is out of range.
    ...
    /**
     * @dev Return the index of the given token address. Reverts if no matching
     * token is found.
    ...
    /**
     * @dev Return current balance of the pooled token at given index
     * @param index the index of the token
    ...
    /**
     * @dev This function reads the accumulated amount of admin fees of the token with given index
    ...
    /**
     * @dev Update the swap fee to be applied on swaps
    ...
    /**
     * @dev Start ramping up or down A parameter towards given futureA and futureTime
    ...
    /**
     * @dev Stop ramping A immediately. Reverts if ramp A is already stopped.
     */
